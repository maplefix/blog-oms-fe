  ...
  <div class="app-container">
    <el-form :inline="true">
      ...
      <el-form-item label="状态">
        <el-select v-model="queryParams.status" placeholder="任务状态" clearable size="small" style="width: 240px">
          <el-option
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" size="small" label-width="90px">
        ...
        <el-form-item label="参数内容">
          <el-input v-model="form.methodParams" placeholder="请输入参数内容"/>
        </el-form-item>
        ...
        <el-form-item label="任务描述">
          <el-input v-model="form.remark" placeholder="请输入任务描述" rows="2" type="textarea"/>
        </el-form-item>
      </el-form>
