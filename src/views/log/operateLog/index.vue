  ...
  <div class="app-container">
    <el-form :inline="true" label-width="68px">
      <el-form-item label="系统模块">
        <el-input v-model="queryParams.module" placeholder="请输入系统模块" clearable style="width: 240px;" size="small"
    ...
    <el-table v-loading="loading" :data="list" style="width: 100%;" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统模块" prop="module"/>
      ...
      <el-table-column label="操作日期" prop="createDate" width="180">
        <template slot-scope="scope">
