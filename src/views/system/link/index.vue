  ...
  <div class="app-container">
    <el-form :inline="true" label-width="68px">
      <el-form-item label="友链名称">
        <el-input v-model="queryParams.linkName" placeholder="请输入友链名称" clearable size="small" style="width: 240px"
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="友链名称" prop="linkName" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="友链名称" prop="linkName">
          <el-input maxlength="128" show-word-limit v-model="form.linkName" placeholder="请输入友链名称"/>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      handleStatus(row, pass) {
        let text = pass ? "通过" : "拒绝";
        this.$confirm('确认要' + text + '"' + row.linkName + '"申请吗?', "警告", {
      ...
      handleDisplayChange(row) {
        ...
        this.$confirm('确认要' + text + '"' + row.linkName + '"数据项吗?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function () {
